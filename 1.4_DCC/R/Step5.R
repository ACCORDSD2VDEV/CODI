...
## remove latitude and longitude before sending to CDC
measures_demo_long_pz1 <- measures_demo_long |> 
        select(-c(latitude, longitude))

## Save csv file. CDC will complete NORC and growthcleanr steps
write_csv(measures_demo_long_pz1, path = "output/measures_demo_long_pregcnorc_pz1.csv")

###### ---------------------------- NORC & Growthcleanr steps below ------------------------- ##############
# # clean measurements
