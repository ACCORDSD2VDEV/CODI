  ...
  FROM (
  	SELECT l.@LINKID_COLUMN_VALUE AS linkid, e.PERSON_ID as patid, e.ENC_ID,
  		CASE WHEN SESSION_DATE >= '2017-1-1' AND SESSION_DATE < '2018-1-1' THEN 2017
	  		 ...
	  		 WHEN  SESSION_DATE >= '2020-1-1' AND SESSION_DATE < '2021-1-1' THEN 2020
	  		 WHEN  SESSION_DATE >= '2021-1-1' AND SESSION_DATE < '2022-1-1' THEN 2021
	  		 WHEN  SESSION_DATE >= '2022-1-1' AND SESSION_DATE < '2023-1-1' THEN 2022
  		END AS yr
