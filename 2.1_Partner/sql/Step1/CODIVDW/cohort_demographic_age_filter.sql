...
FROM (
  ...
  WHERE 
  	...
  	(yr = 'SY3' AND study_age_yrs_SY3 BETWEEN 2 AND 19) OR
    (yr = 'SY4' AND study_age_yrs_SY4 BETWEEN 2 AND 19) OR
    (yr = 'SY5' AND study_age_yrs_SY5 BETWEEN 2 AND 19) OR
    (yr = 'SY6' AND study_age_yrs_SY6 BETWEEN 2 AND 19) 
) a;
